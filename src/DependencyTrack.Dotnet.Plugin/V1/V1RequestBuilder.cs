...
using System;
using WeMicroIt.DependencyTrack.Dotnet.V1.Bom;
namespace WeMicroIt.DependencyTrack.Dotnet.V1 {
    /// <summary>
    /// Builds and executes requests for operations under \v1
    /// </summary>
    public class V1RequestBuilder : BaseRequestBuilder {
        /// <summary>The bom property</summary>
        public BomRequestBuilder Bom { get =>
            new BomRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
